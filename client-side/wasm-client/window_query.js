...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_windowquery')) {
        Object.defineProperty(Module['ready'], '_windowquery', { configurable: true, get: function() { abort('You are getting _windowquery on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_windowquery', { configurable: true, set: function() { abort('You are setting _windowquery on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_strlength')) {
        Object.defineProperty(Module['ready'], '_strlength', { configurable: true, get: function() { abort('You are getting _strlength on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_strlength', { configurable: true, set: function() { abort('You are setting _strlength on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
// refer to Module (if they choose; they can also define Module)
  ...
  (function() {
    ...
    var loadPackage = function(metadata) {
      ...
      var PACKAGE_NAME = 'window_query.data';
      var REMOTE_PACKAGE_BASE = 'window_query.data';
...
Module['FS_createPath']("/", "files", true, true);
      ...
      function processPackageData(arrayBuffer) {
        ...
        // Reuse the bytearray from the XHR as the source for file reads.
          ...
          }          Module['removeRunDependency']('datafile_window_query.data');

      };
      Module['addRunDependency']('datafile_window_query.data');
    ...
    loadPackage({"files": [{"filename": "/files/bitmap.txt.C", "start": 0, "end": 5050488}, {"filename": "/files/geom_10_x.bin", "start": 5050488, "end": 23007728}, {"filename": "/files/geom_10_y.bin", "start": 23007728, "end": 40964968}, {"filename": "/files/r-tree.c.dat", "start": 40964968, "end": 43471720}, {"filename": "/files/r-tree.c.idx", "start": 43471720, "end": 43485788}, {"filename": "/files/rtree_pointers.c", "start": 43485788, "end": 43581733}], "remote_package_size": 43581733, "package_uuid": "e90b1de9-0b86-4c05-8d77-2ec4f97f788f"});
...
var wasmBinaryFile;
  wasmBinaryFile = 'window_query.wasm';
...
/** @type {function(...*):?} */
var _strlength = Module["_strlength"] = createExportWrapper("strlength");

/** @type {function(...*):?} */
var _windowquery = Module["_windowquery"] = createExportWrapper("windowquery");
